...
<head>
  ...
  <title>@yield('pagetitle', 'Unkown') - Ecomshop Dashboard</title>
        ...
        <ul class="navbar-nav navbar-right">
            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
											text-white"> <img
                      alt="image" src="{{ asset('dashboard_asset/assets/img/users/user-1.png') }}"
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
              class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image"
                src="{{ asset('dashboard_asset/assets/img/user.png') }}" class="user-img-radious-style"> <span
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Sub
                  Category</span></a>
              <ul class="dropdown-menu">
            ...
            <li class="menu-header">Product Maitain Section</li>
            <li><a class="nav-link" href="{{ route('admin.addproduct') }}"><i data-feather="file"></i><span>Add
                  Product</span></a></li>
            <li><a class="nav-link" href="{{ route('admin.allproduct') }}"><i data-feather="file"></i><span>All
                  Product</span></a></li>
            <li class="menu-header">Other Section</li>
            <li><a class="nav-link" href="{{ route('admin.message') }}"><i
                  data-feather="file"></i><span>Messages</span></a></li>
