                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image"
                                src="{{ asset('dashboard_asset/assets/img/logo.png') }}" class="header-logo" /> <span
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="nav-link" href="{{ route('admin.addproduct') }}"><i
                                    data-feather="file"></i><span>Add Product</span></a></li>
                        <li><a class="nav-link" href="{{ route('admin.allproduct') }}"><i
                                    data-feather="file"></i><span>All Product</span></a></li>
